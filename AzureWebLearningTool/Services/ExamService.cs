...
namespace AzureWebLearningTool.Services
{
    public class ExamService : IExamService
    {
        ...
        List<Question> GetQuestions()
        {
            ...
            {
                new Question() {Text = "What is the most common cloud type?", Id = 0},
                new Question() {Text = "Which cloud service model is rapidly gaining popularity among developers?",Id = 1},
                new Question() {Text = "What is Vertical Scaling?",Id = 2},
                new Question() {Text = "What is Horizontal Scaling?",Id = 3},
                new Question() {Text = "What aspects have to be managed in IaaS?",Id = 4},
                new Question() {Text = "Which of the following are true about IaaS?",Id = 5},
                new Question() {Text = "What do you manage when choosing the PaaS cloud service model?",Id = 6},
                new Question() {Text = "Which of the following is true about SaaS?",Id = 7},
                new Question() {Text = "Identity management can be achieved without a single physical server for you to manage",Id = 8},
                new Question() {Text = "What is a Resource Group?",Id = 9},
                new Question() {Text = "How many Resource Groups can a resource be a part of?",Id = 10},
                new Question() {Text = "Why wouldn't you be able to deploy a resource?",Id = 11},
                new Question() {Text = "What properties are present in resources managed by ARM?",Id = 12},
                new Question() {Text = "What is Microsoft.Compute an example of?",Id = 13},
                new Question() {Text = "What is Microsoft.Compute/virtualMachines an example of?",Id = 14},
                new Question() {Text = "What is the Resource Provider for virtual machines?",Id = 15},
                new Question() {Text = "Azure Virtual Machines are an example of which cloud service model?",Id = 16},
            };
